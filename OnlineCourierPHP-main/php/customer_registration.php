...
function addUser($username,$password,$email,$phone,$city,$state ,$gender , $fullname , $address)
{
  $password=md5($password);

    $query = "INSERT INTO users  VALUES (0,'$username','$password',4,'$email',null,null,
...
if (empty($_POST["gender"]))
    ...
    if (empty($_POST["state"]))
      ...
      addUser($username,$password,$email,$phone_no,$city,$state ,$gender , $fullname , $address);
